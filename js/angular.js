 ...
 * You would then inject and use this service like this:
 * <pre>
 *   someModule.controllers 'Ctrl', ['ping', (ping)->
 *     ping.send()
 *   ]
 * </pre>
 */
      ...
      function nodeLinkFn(childLinkFn, scope, linkNode, $rootElement, boundTranscludeFn) {
        ...
        if (controllerDirectives) {
          forEach(controllerDirectives, function(directive) {
            ...
            // Directives with element transclusion and a controllers need to attach controllers
    ...
    return function(expression, locals) {
      ...
      if (identifier) {
        if (!(locals && typeof locals.$scope == 'object')) {
          throw minErr('$controller')('noscp', "Cannot export controllers '{0}' as '{1}'! No $scope object provided via `locals`.", constructor || expression.name, identifier);
        }
   ...
   <doc:example module="customInterpolationApp">
     <doc:source>
      <script>
        ...
        customInterpolationApp.controllers('DemoController', function DemoController() {
...
function $ParseProvider() {
   ...
   * access in templates (accessed as raw values) and controllers code (accessed as promises).
   *
 ...
 *
 * @param {string=} name|ngForm Name of the form. If specified, the form controllers will be published into
 ...
 * @example
    <doc:example>
      <doc:source>
       ...
       <form name="myForm" ng-controllers="Ctrl">
 ...
 *     constructor function. The controllers instance can be published into a scope property
 ...
 * controllers's instance. This allows for easy access to the view data from the controllers. Also
 ...
 * @example
   <doc:example>
     <doc:source>
      ...
      <form ng-submit="submit()" ng-controllers="Ctrl">
